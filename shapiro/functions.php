...
function shapiro_setup() {
	/*
		...
		* If you're building a theme based on shapiro, use a find and replace
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'shapiro' ),
		)
	);
...
function shapiro_scripts() {
	...
	wp_enqueue_script( 'shapiro-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
